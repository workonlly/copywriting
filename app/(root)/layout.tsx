    ...
    <div className="flex flex-col h-screen">
      ...
      <nav className="mx-5 my-1">
        <ul className="flex flex-row text-sm font-semibold gap-3">
          ...
          <li>
            <Link href="/grocery" className="block px-4 py-2 rounded hover:bg-violet-500 hover:text-white transition-colors">Grocery</Link>
          </li>
          <li>
            <Link href="/privacy" className="block px-4 py-2 rounded hover:bg-violet-500 hover:text-white transition-colors">Privacy</Link>
          </li>
          <li>
            <Link href="/terms" className="block px-4 py-2 rounded hover:bg-violet-500 hover:text-white transition-colors">Terms&Condition</Link>
          </li>
        </ul>
      </nav>
      <div className="p-2">
